...
public class NetworkManager : MonoBehaviour
{
    ...
    [Header("PAYLOADS")]
    public string payloadLogin = "login";
    public string payloadAllEditions;
    public string payloadCurrentEdition;
    [Space]
                ...
                case UnityWebRequest.Result.Success:
                    {
                        ...
                        JsonUtility.FromJsonOverwrite(response, GameManager.instance.userSettings);
                        OnLogin?.Invoke(true);
                    }
                    break;
            }
